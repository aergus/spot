var Elm = Elm || { Native: {} };
Elm.Auxiliary = Elm.Auxiliary || {};
Elm.Auxiliary.make = function (_elm) {
   "use strict";
   _elm.Auxiliary = _elm.Auxiliary || {};
   if (_elm.Auxiliary.values)
   ...
   var elemAt = F2(function (l,n) {
      return _U.eq(n,
      0) ? $List.head(l) : A2(elemAt,
      $List.tail(l),
      n - 1);
   });
   var moveAt = F2(function (m,d) {
      return function () {
         switch (d.ctor)
         {case "Down": return m.down;
...
Elm.Drawing.make = function (_elm) {
      ...
      return function () {
         ...
         {case "_Tuple2":
            return $Graphics$Collage.move({ctor: "_Tuple2"
                                          ...
                                          ,_1: toOffset(_v0._1)});}
         _U.badCase($moduleName,
         "on line 27, column 32 to 68");
      }();
   };
   var backgroundForms = function () {
      var size = $Parameters.blockSize + $Parameters.marginSize * 0.5;
      return A2($List.map,
      function (p) {
   ...
   var blockForm = function (l) {
      return function () {
         ...
         return $Graphics$Collage.group(_L.fromArray([A2($Graphics$Collage.filled,
                                                     ...
                                                     blockRect)
                                                     ,function () {
                                                        var s = $Graphics$Collage.solid($Parameters.mg);
                                                        return A2($Graphics$Collage.outlined,
                                                        _U.replace([["width"
                                                                    ,$Parameters.marginSize * 0.6]
                                                                   ,["cap"
                               ...
                               switch (_v13._1._1.ctor)
                                 {case "_Tuple2":
                                    return function () {
                                         ...
                                         var x$ = toOffset(_v13._1._1._0);
                                         var y = toOffset(_v13._0._1);
                                         var x = toOffset(_v13._0._0);
   ...
   var toScene = function (s) {
      return function () {
         ...
         function () {
            var f = s.field;
            return _U.eq(s.animation,
            $Maybe.Nothing) && _U.eq({_: {}
                                     ,down: f
                                     ,left: f
                                     ,right: f
                                     ,up: f},
   ...
   var update = F2(function (e,x) {
      return function () {
         ...
         {case "Animation":
              ...
              function (s) {
                 ...
                 function (k) {
                    return function () {
                       var k$ = k + e._0;
                       return _U.cmp(k$,
                       $Parameters.animationDuration) > -1 ? function () {
                          var fd = A2($Dict.map,
                          F2(function (p,b) {
                          ...
                          fd$ = $._0,
                          sd$ = $._1;
                          return _U.replace([["field",fd$]
                                            ,["seed",sd$]
                                            ,["animation",$Maybe.Nothing]
                                            ,["moves"
                                             ,$Transitions.nextMoves(fd$)]],
                          s);
            ...
            case "Initialization":
            return function () {
                 var fd = $Parameters.emptyField($Parameters.dimension);
                 var $ = A2($Transitions.addRandomBlock,
                 fd,
                 ...
                 return $Maybe.Just({_: {}
                                    ,animation: $Maybe.Nothing
                                    ,field: fd$$
                                    ,moves: $Transitions.nextMoves(fd$$)
                                    ,seed: sd$$});
              }();
            case "Move":
            return A2($Maybe.map,
              function (s) {
                 return !_U.eq(s.animation,
                 $Maybe.Nothing) ? s : function () {
                    var fd = A2($Auxiliary.moveAt,
                    s.moves,
                    e._0);
                    return _U.eq(s.field,
                    fd) ? s : _U.replace([["field"
                                          ,fd]
                                         ,["animation",$Maybe.Just(0)]],
                    s);
                 }();
              },
              x);}
...
Elm.Parameters = Elm.Parameters || {};
Elm.Parameters.make = function (_elm) {
   "use strict";
   _elm.Parameters = _elm.Parameters || {};
   if (_elm.Parameters.values)
   ...
   var blockSize = 100;
   var dimension = 4;
   var sceneSize = function () {
      var d = $Basics.toFloat(dimension);
      return d * blockSize + (d + 1) * marginSize;
   }();
   _elm.Parameters.values = {_op: _op
                            ,dimension: dimension
                            ,blockSize: blockSize
...
Elm.Transitions = Elm.Transitions || {};
Elm.Transitions.make = function (_elm) {
   "use strict";
   _elm.Transitions = _elm.Transitions || {};
   if (_elm.Transitions.values)
   ...
   $Random = Elm.Random.make(_elm),
   $Types = Elm.Types.make(_elm);
   var atToWhole = F3(function (fct,
   d,
   f) {
      return A4($List.foldr,
      _U.eq(d,$Types.Up) || _U.eq(d,
      $Types.Right) ? F2(function (x,
      y) {
         return function ($) {
            return x(y($));
         };
   ...
   var nextMoves = function (f) {
      return {_: {}
             ,down: A2(move,$Types.Down,f)
             ,left: A2(move,$Types.Left,f)
             ,right: A2(move,$Types.Right,f)
             ,up: A2(move,$Types.Up,f)};
   };
   var addRandomBlock = F2(function (f,
   s) {
      return function () {
         var frees = function ($) {
         ...
         0) ? {ctor: "_Tuple2"
              ,_0: f
              ,_1: s} : function () {
            var range = $Parameters.dimension / 2 | 0;
